...
// at runtime.
//
// Note: This constant was previously defined as TColor::LtGray. However, TColor::LtGray is also a
// static variable, and since the initialization order of static variables is undefined, it would
// lead to DefaultFaceColor sometimes being initialized as (0, 0, 0) (i.e. black).
//
const TColor TBtnBitmap::DefaultFaceColor(192, 192, 192);
