...
int
TApplication::MessageBox(HWND wnd, uint resId, const tstring& caption, uint type, ...) const
{
  PRECONDITION(resId);
...
//
int
TApplication::MessageBox(HWND wnd, uint resId, LPCTSTR caption, uint type, ...) const
{
  PRECONDITION(resId);
