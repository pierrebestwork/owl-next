...
#
#   COMPVER=730          C++Builder 10.2 Berlin (0x730)
...
!elif $(COMPVER) < 17
!  error Unsupported compiler version; COMPVER must be >= 17 (C++Builder XE6 (0x680)).
!endif
BCCVER = $(COMPVER)
...
CFLAGS = $(CFLAGS) -w-inl # W8027 "Functions with exception specifications are not expanded inline"; too many, and not that useful.
