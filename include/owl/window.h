...
class _OWLCLASS TWindow : virtual public TEventHandler,
  ...
  public:
    ...
    int               FormatMessageBox(LPCTSTR text, LPCTSTR caption, uint flags, va_list argp) const;
    int               FormatMessageBox(LPCTSTR text, LPCTSTR caption, uint flags, ...) const;
    int               FormatMessageBox(const tstring& text, const tstring& caption, uint flags, va_list argp) const;
    int               FormatMessageBox(const tstring& text, const tstring& caption, uint flags, ...) const;
    int               FormatMessageBox(uint resId, LPCTSTR caption, uint flags, va_list argp) const;
    int               FormatMessageBox(uint resId, LPCTSTR caption = 0, uint flags = MB_OK, ...) const;
    int               FormatMessageBox(uint resId, const tstring& caption, uint flags, va_list argp) const;
    int               FormatMessageBox(uint resId, const tstring& caption, uint flags = MB_OK, ...) const;
  ...
  protected:
    ...
    bool              EvMouseHWheel(uint modKeys, int zDelta, const TPoint& point);
...
inline int
TWindow::FormatMessageBox(const tstring& text, const tstring& caption, uint flags,  va_list argp) const
{
